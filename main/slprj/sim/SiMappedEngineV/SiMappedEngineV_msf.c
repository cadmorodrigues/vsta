...
) { o2k4rz0uw5x * dw = ( o2k4rz0uw5x * ) ssGetDWork ( S , 0 ) ; real_T *
o_o_B_2_1 = ( real_T * ) ssGetOutputPortSignal ( S , 0 ) ; fpgmc1blog *
localX = ( fpgmc1blog * ) ssGetContStates ( S ) ; const real_T *
i_i_i_plq14ufrxm = ( real_T * ) ssGetInputPortSignal ( S , 1 ) ; if ( tid ==
0 ) { SiMappedEngineV ( & ( dw -> rtm ) , o_o_B_2_1 , & ( dw -> rtb ) ,
localX ) ; pj3vtlmlns ( & ( dw -> rtm ) , i_i_i_plq14ufrxm , & ( dw -> rtdw )
...
CONSTANT_TID && tid != PARAMETER_TUNING_TID ) { SiMappedEngineV ( & ( dw ->
rtm ) , o_o_B_2_1 , & ( dw -> rtb ) , localX ) ; } }
#define MDL_UPDATE
static void mdlUpdate ( SimStruct * S , int_T tid ) { o2k4rz0uw5x * dw = (
o2k4rz0uw5x * ) ssGetDWork ( S , 0 ) ; const real_T * i_i_i_plq14ufrxm = (
real_T * ) ssGetInputPortSignal ( S , 1 ) ; pj3vtlmlns ( & ( dw -> rtm ) ,
i_i_i_plq14ufrxm , & ( dw -> rtdw ) ) ; return ; }
...
i_i_i_plq14ufrxm , & ( dw -> rtdw ) , localZCSV ) ; }
#define MDL_DERIVATIVES
static void mdlDerivatives ( SimStruct * S ) { o2k4rz0uw5x * dw = (
o2k4rz0uw5x * ) ssGetDWork ( S , 0 ) ; const real_T * i_ec0csx13uo = ( real_T
* ) ssGetInputPortSignal ( S , 0 ) ; const real_T * i_i_i_plq14ufrxm = (
