...
MODEL                = rtwshared
MODULES              = automldiffas_4HAP7ofC.c binsearch_u32d.c look1_binlcpw.c plook_u32d_binckan.c rtGetInf.c rtGetNaN.c rt_nonfinite.c rt_zcfcn.c abs_lf2wV9oj.c any_GLXv7GwU.c atan2_icYkhKZQ.c atan_gH4krsPB.c cos_PHKeDwWB.c exp_vDnfMKfl.c look1_binlxpw.c magiccos_HYUmiojY.c magiccos_QN7JO5Hp.c magiccos_StX1ppRt.c magiccos_l8cgEVUW.c magicsin_9ybvce8u.c magicsin_jIWN8Ib5.c power_wC4nHUsl.c rollingMoment_WUS88JAs.c rt_mrdivide_U1d1x3_U2d3x3_Yd1x3_snf.c sign_aEDXoCpN.c sin_SGEmn1EW.c sqrt_SPIkWWrF.c tan_6Zz5vwAK.c tanh_ljC7INdK.c look2_binlcpw.c intrp4d_la_pw.c intrp5d_la_pw.c plook_binca.c
...
MASTER_ANCHOR_DIR    = 
START_DIR            = C:/Users/Cd/Desktop/Mestrado/MODELO~1/TRABAL~1/modelo/DBLLAN~1/main/Work
S_FUNCTIONS_LIB      = 
NUMST                = 
NCSTATES             = 0
